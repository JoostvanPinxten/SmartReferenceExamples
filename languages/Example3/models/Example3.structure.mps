...
<model ref="r:e85fae2c-a1a4-498a-9ba7-1f32436bc3eb(Example3.structure)">
  ...
  <node concept="1TIwiD" id="caO$QSDdCa">
    ...
    <property role="TrG5h" value="L3_RootConcept" />
    ...
    <node concept="1TJgyj" id="caO$QSDntN" role="1TKVEi">
      ...
      <ref role="20lvS9" node="caO$QSDntL" resolve="L3_AnotherConcept" />
    </node>
    <node concept="1TJgyj" id="caO$QSDdCb" role="1TKVEi">
      ...
      <property role="20lbJX" value="0..n" />
      <ref role="20lvS9" node="caO$QSDdC9" resolve="L3_SomeConcept" />
    </node>
  </node>
  <node concept="1TIwiD" id="caO$QSDdC9">
    <property role="EcuMT" value="219218763133016585" />
    <property role="TrG5h" value="L3_SomeConcept" />
    <ref role="1TJDcQ" to="tpck:gw2VY9q" resolve="BaseConcept" />
    ...
    <node concept="1TJgyj" id="caO$QSDfTR" role="1TKVEi">
      ...
      <property role="20lbJX" value="0..n" />
      <ref role="20lvS9" node="caO$QSDnKr" resolve="L3_BaseRef" />
    </node>
  </node>
  <node concept="1TIwiD" id="caO$QSDecI">
    <property role="EcuMT" value="219218763133018926" />
    <property role="TrG5h" value="L3_SomeConceptRef" />
    <ref role="1TJDcQ" node="caO$QSDnKr" resolve="L3_BaseRef" />
  ...
  <node concept="1TIwiD" id="caO$QSDntL">
    ...
    <property role="TrG5h" value="L3_AnotherConcept" />
    <ref role="1TJDcQ" to="tpck:gw2VY9q" resolve="BaseConcept" />
  ...
  <node concept="1TIwiD" id="caO$QSDntM">
    ...
    <property role="TrG5h" value="L3_AnotherConceptRef" />
    <ref role="1TJDcQ" node="caO$QSDnKr" resolve="L3_BaseRef" />
  ...
  <node concept="1TIwiD" id="caO$QSDnKr">
    ...
    <property role="TrG5h" value="L3_BaseRef" />
