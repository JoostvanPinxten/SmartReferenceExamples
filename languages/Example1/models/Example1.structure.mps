...
<model ref="r:c29124b7-2023-46cf-9723-e6279c137d9f(Example1.structure)">
  ...
  <node concept="1TIwiD" id="caO$QSDdC9">
    ...
    <property role="TrG5h" value="L1_SomeConcept" />
    ...
    <node concept="1TJgyj" id="caO$QSDfTR" role="1TKVEi">
      ...
      <ref role="20lvS9" node="caO$QSDecI" resolve="L1_SomeConceptRefWithoutEditor" />
    </node>
  </node>
  <node concept="1TIwiD" id="caO$QSDdCa">
    <property role="EcuMT" value="219218763133016586" />
    <property role="TrG5h" value="L1_RootConcept" />
    ...
    <node concept="1TJgyj" id="caO$QSDdCb" role="1TKVEi">
      ...
      <property role="20lbJX" value="0..n" />
      <ref role="20lvS9" node="caO$QSDdC9" resolve="L1_SomeConcept" />
    </node>
  </node>
  <node concept="1TIwiD" id="caO$QSDecI">
    <property role="EcuMT" value="219218763133018926" />
    <property role="TrG5h" value="L1_SomeConceptRefWithoutEditor" />
    <ref role="1TJDcQ" to="tpck:gw2VY9q" resolve="BaseConcept" />
